...
//        Case 2
        ...
        FrogJmpVersion2 answerSolution =new FrogJmpVersion2();
    ...
    public int solution(int X, int Y, int D){
        ...
        int oneJump = D;
        int sumJumps =distanceToTravel/oneJump;
...
//        System.out.println(" Sum Jumps "+sumJumps);
        ...
        //if modulus is difrent then 0 it means more jumps
